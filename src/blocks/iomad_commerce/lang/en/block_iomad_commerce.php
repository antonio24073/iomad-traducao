...
$string['courseshoptagcreated'] = 'Course shop tag created';
$string['courseshoptagdeleted'] = 'Course shop tag deleted';
...
$string['deleteshoptag'] = 'Delete shop tag - {$a}';
$string['deleteshoptagcheck'] = 'Are you sure you want to delete this shop tag?';
$string['deleteshoptagcheckused'] = 'It is being used by the shop items: {$a}. Are you sure you want to delete this shop tag?';
...
$string['howmanylicences'] = 'How many licenses?';
...
$string['iomad_commerce:manage_tags'] = 'Manage tags';
...
$string['itemsusedby'] = 'Items using the tag';
...
$string['managetagsviewed'] = 'Manage tags viewed';
...
$string['notagsexist'] = 'There are no tags available';
$string['notconfigured'] = 'The eCommerce block has not been configured. Check the settings page for the block';
$string['onlyonecoursepath'] = 'You cannot select courses and learning paths';
...
$string['privacy:metadata'] = 'The E-Commerce block stores personal data for invoices created.';
...
$string['requiredcoursepath'] = 'You need to select a course or learning path';
...
$string['shoptagdeleted'] = 'Shop tag deleted';
...
$string['tagnameupdated'] = 'Shop tag name updated';
...
$string['user_basket_cleanup_task'] = 'Abandonded shopping baskets cleanup task';
$string['value'] = 'Value';
$string['xshopitems'] = '{$a}\'s shop items';
$string['xshoptag'] = '{$a} shop tag';
