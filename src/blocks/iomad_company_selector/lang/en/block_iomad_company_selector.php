...
$string['iomad_company_selector:addinstance'] = 'Add a new company selector block';
$string['iomad_company_selector:myaddinstance'] = 'Add a new company selector block to the users dashboard';
$string['nocurrentcompany'] = 'Please select a company from the drop down list';
$string['pluginname'] = 'Company Selector';
