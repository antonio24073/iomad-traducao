...
/**
 * IOMAD microlearning language strings
...
$string['crontask'] = 'microlearning cron';
...
$string['iomad_microlearning:view'] = 'View microlearning';
...
$string['pluginname'] = 'microlearning threads';
$string['privacy:metadata'] = 'The Microlearning block only shows data stored in other locations.';
$string['privacy:metadata:microlearning_thread_user'] = 'Microlearning thread user data information. No personal data is kept.';
$string['privacy:metadata:microlearning_thread_user:accesskey'] = 'Microlearning thread email access key';
$string['privacy:metadata:microlearning_thread_user:due_date'] = 'Microlearning thread due date';
$string['privacy:metadata:microlearning_thread_user:groupid'] = 'Microlearning thread  group id';
$string['privacy:metadata:microlearning_thread_user:id'] = 'Microlearning thread record id';
$string['privacy:metadata:microlearning_thread_user:message_delivered'] = 'Microlearning thread message delivered indicator';
$string['privacy:metadata:microlearning_thread_user:messagetime'] = 'Microlearning thread time to send messages after';
$string['privacy:metadata:microlearning_thread_user:nuggetid'] = 'Microlearning thread nugget id';
$string['privacy:metadata:microlearning_thread_user:reminder1_date'] = 'Microlearning thread first reminder date';
$string['privacy:metadata:microlearning_thread_user:reminder1_delivered'] = 'Microlearning thread first reminder delivered indicator';
$string['privacy:metadata:microlearning_thread_user:reminder2_date'] = 'Microlearning thread second reminder date';
$string['privacy:metadata:microlearning_thread_user:reminder2_delivered'] = 'Microlearning thread second reminder delivered indicator';
$string['privacy:metadata:microlearning_thread_user:schedule_date'] = 'Microlearning thread scheduled date';
$string['privacy:metadata:microlearning_thread_user:threadid'] = 'Microlearning thread id';
$string['privacy:metadata:microlearning_thread_user:timecompleted'] = 'Microlearning thread nugget time completed';
$string['privacy:metadata:microlearning_thread_user:timecreated'] = 'Microlearning thread time created';
